...
describe('The Message Section', () => {
    ...
    it('should have an input field', async () => {
        await act(async () => render(<WithOverlayService overlayService={defaultOverlayService}><MessageAdmin/></WithOverlayService>))
        expect(screen.getByLabelText(/message/i)).to.exist
    })
    ...
    it('should get initial message from overlay service context', async () => {
        ...
        await act(async () => render(<WithOverlayService overlayService={overlayService}><MessageAdmin/></WithOverlayService>))
        expect(screen.getByLabelText(/message/i).value).to.eql('Test Message')
    })
